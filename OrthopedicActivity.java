...
public class OrthopedicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orthopedic); // Ensure this XML file exists
        ...
        doctorListView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(OrthopedicActivity.this, DoctorProfileActivity.class);
    ...
    private void fetchDoctors() {
        db.collection("doctors").whereEqualTo("specialty", "Orthopedic").get()
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        doctorList.clear();
                        if (task.getResult().isEmpty()) {
                            Toast.makeText(this, "No Orthopedic Specialists found", Toast.LENGTH_SHORT).show();
                        }
